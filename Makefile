...
COMPOSE_WORK_BRANCH                  ?= loong64-v5.5.0
...
GITLAB_RUNNER_WORK_BRANCH            ?= loong64-v19.3.0
GO_CONTAINERREGISTRY_WORK_BRANCH     ?= loong64-v0.22.0
GRADLE_WORK_BRANCH                   ?= loong64-9.7.1
HTOP_WORK_BRANCH                     ?= loong64-3.5.3
JENKINS_WORK_BRANCH                  ?= loong64-2.579
...
NEXUS_WORK_BRANCH                    ?= loong64-3.95.2
