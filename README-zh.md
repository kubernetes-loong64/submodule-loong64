...
| [compose-loong64](https://github.com/kubernetes-loong64/compose-loong64)                                   | Docker Compose loong64 移植                                             | `loong64-v5.5.0`               |
...
| [gitlab-runner-loong64](https://github.com/kubernetes-loong64/gitlab-runner-loong64)                       | gitlab-runner-helper 容器镜像 LoongArch64 移植                          | `loong64-v19.3.1`              |
| [go-containerregistry-loong64](https://github.com/kubernetes-loong64/go-containerregistry-loong64)         | go-containerregistry CLI 工具 (crane、gcrane、krane) 容器镜像           | `loong64-v0.22.0`              |
...
| [jenkins-loong64](https://github.com/kubernetes-loong64/jenkins-loong64)                                   | Jenkins LoongArch64 容器镜像                                            | `loong64-2.579`                |
...
| [nexus-loong64](https://github.com/kubernetes-loong64/nexus-loong64)                                       | Nexus Repository Manager LoongArch64 容器镜像                           | `loong64-3.95.2`               |
